      ...
      <header className="relative z-10 border-b border-border backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
          <div className="flex items-center gap-3">
            ...
            <span className="ml-3 hidden rounded-full border border-border bg-secondary/40 px-2.5 py-0.5 text-[10px] uppercase tracking-[0.2em] text-muted-foreground sm:inline-block">
              {role}
            </span>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <form action={signOut}>
              <button
                type="submit"
                className="rounded-full border border-border bg-secondary/40 px-4 py-2 text-xs uppercase tracking-wider text-muted-foreground transition-all hover:bg-secondary hover:text-foreground"
              >
                Déconnexion
              </button>
            </form>
